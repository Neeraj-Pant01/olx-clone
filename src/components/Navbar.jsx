        ...
        <nav className="bg-gray-100 flex items-center justify-between py-3 shadow-md sticky top-0 px-3 z-[991]">
            {
                location.pathname === "/upload" ?
                    ...
                    <>
                        ...
                        <div className='text-[#002f34] font-semibold text-sm'>
                            ENGLISH
                        </div>
                        <div className="flex items-center gap-[20px]">
                            {
                                user ?
                                    <div className="flex flex-col items-center justify-center gap-1">
                                        <img src="https://static.vecteezy.com/system/resources/thumbnails/013/263/214/small/young-boy-cartoon-character-portrait-isolated-icon-design-white-background-free-vector.jpg" alt="" className='w-[35px] h-[32px] rounded-full cursor-pointer' onClick={() => navigate(`/seller/${user?._id}`)} />

                                        <b className='text-xs cursor-pointer' onClick={()=>{localStorage.clear()
